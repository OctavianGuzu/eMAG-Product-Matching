...
public class Category {
    ...
    public void find_Category() throws IOException {
        ...
        PrintWriter out = new PrintWriter(new FileWriter("Produse_si_categorii_output_bogdan.csv"));
        for (int i = 0; i < obj.products.size(); i++) {
            ...
            if (currentProduct.contains(" - ")) {
                ...
                out.println(obj.IDs.get(i) + ";" + "Carti");
            ...
            //out.println(obj.IDs.get(i) + ";" + categoriesEN.get(index));
